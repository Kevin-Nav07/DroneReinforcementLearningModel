...
class CrazyFlieEnvVelocity(gym.Env):
    ...
    def __init__(
        ...
        #
        tilt_min_z: float = 0.30,  # raised from 0.30 — 25° lean needs more clearance
        # ── Safety ────────────────────────────────────────────────────────────
        ...
        # ── Commander limits ──────────────────────────────────────────────────
        # max_roll/pitch 6°→12°: doubles corrective torque available to the policy.
        # At 25° spawn tilt the 6° limit was physically insufficient to arrest
        # angular momentum within the episode length — 12° fixes this.
        # For hover with no tilt, 12° is still conservative and safe.
        self.max_roll_deg    = 50.0
        self.max_pitch_deg   = 50.0
