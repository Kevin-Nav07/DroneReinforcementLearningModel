"""
EvaluationVelocityReal.py — Pure policy evaluation on the real Crazyflie, scaled-env test.
...
from CrazyFlieEnvReal2_pure_policy_scaled import CrazyFlieRealEnvVelocity
