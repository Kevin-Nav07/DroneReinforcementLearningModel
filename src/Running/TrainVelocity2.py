...
──────────────────────────────────────────────────────────────────────────────
  ...
  LR:         5e-5 → 2e-5  (raised floor from 1e-5: HARD DR consolidation needs
                            meaningful learning rate, not pure fine-tuning)
...
if __name__ == "__main__":
    ...
    def lr_schedule(progress_remaining: float) -> float:
        return 2e-5 + progress_remaining * (5e-5 - 2e-5)
    ...
    print(f"  LR 5e-5→2e-5 | clip 0.10→0.05 | kl=0.015 | ENT 0.005→0.001")
