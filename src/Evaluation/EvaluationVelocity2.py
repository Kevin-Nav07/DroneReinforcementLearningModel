...
if __name__ == "__main__":
    ...
    models_dir = os.path.abspath(os.path.join(here, "..", "models", "VerticalComplex_DR_Curriculum"))
    models_dir2 = os.path.abspath(os.path.join(here, "..", "models", "VerticalComplex_DR_Curriculum", "stage4_very_high_noise"))
    model_path = os.path.join(models_dir, "complex_dr_curriculum_final.zip")        
    norm_path = os.path.join(models_dir, "vecnormalize_curriculum.pkl")   
